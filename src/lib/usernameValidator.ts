...
const BLOCKED_WORDS: string[] = [
  ...
  'penis', 'vagina', 'anus', 'nazi', 'hitler', 'rape', 'rapist',
  'pedo', 'pedophile', 'molest', 'porn', 'hentai', 'dildo',
  'wank', 'twat', 'bollock', 'bastard', 'arsehole', 'asshole',
  'motherfuck', 'dickhead', 'shithead', 'dumbass', 'jackass',
  'homo', 'tranny', 'dyke', 'spic', 'chink', 'kike', 'gook',
  'wetback', 'beaner', 'cracker', 'redneck', 'coon',

  // Spanish slurs and profanity
  'puta', 'puto', 'mierda', 'cono', 'joder', 'follar', 'verga',
  'pendejo', 'pendeja', 'cabron', 'culo', 'marica',
  'maricon', 'zorra', 'perra', 'chingar', 'pinche',
  'huevon', 'malparido', 'gonorrea', 'hijueputa',
  'mamon', 'gilipollas', 'capullo', 'cojones',
  'pollas', 'polla', 'chocho', 'bollera', 'sudaca',
  'negrata',

  // Common circumventions
  'phuck', 'phuk', 'fuk', 'fck', 'sht', 'btch', 'dck',
  'azz', 'a55', 'b1tch', 'sh1t', 'f4g', 'n1gger', 'n1gga',
];
...
const BLOCKED_USERNAMES: string[] = [
  ...
  'god', 'satan', 'devil', 'isis', 'alqaeda', 'taliban',
  'kkk', 'sexsex', 'xxx', 'anal', 'oral', 'cum',
];
