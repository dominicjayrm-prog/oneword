export default {
  ...
  results: {
    ...
    cancel: 'CANCELAR',
    browse_past_words: 'Explorar palabras anteriores',
  },
  ...
  profile: {
    ...
    sounds_master: 'Efectos de Sonido',
    sounds_game: 'Sonidos del Juego',
    sounds_celebrations: 'Celebraciones',
  ...
  // Username validation
  username: {
    notAvailable: 'Ese nombre de usuario no est\u00E1 disponible. Por favor, elige otro.',
    tooShort: 'El nombre debe tener al menos 3 caracteres',
    tooLong: 'El nombre debe tener 20 caracteres o menos',
    invalidChars: 'Solo letras, n\u00FAmeros y guiones bajos',
    mustStartWithLetter: 'Debe empezar con una letra',
    consecutiveUnderscores: 'No se permiten guiones bajos consecutivos',
  },
  ...
  errors: {
    ...
    save_settings_failed: 'No se pudo guardar. Inténtalo de nuevo.',
    load_friends_leaderboard: 'No se pudieron cargar los resultados de amigos',
  ...
  // Notifications
  notifications: {
    permission_title: 'Mantente en el juego',
    permission_body: 'Recibe recordatorios cuando haya nuevas palabras, ve tus resultados y protege tu racha.',
    permission_enable: 'Activar Notificaciones',
    permission_later: 'Quiz\u00E1s luego',
    settings_title: 'Notificaciones',
    section_daily: 'RECORDATORIO DIARIO',
    daily_reminder: 'Recordatorio de palabra diaria',
    daily_time: 'Recordarme a las',
    section_streak: 'RACHA',
    streak_risk: 'Alerta de racha en riesgo',
    section_results: 'RESULTADOS',
    results_ready: 'Resultados diarios listos',
    section_social: 'SOCIAL',
    friend_requests: 'Solicitudes de amistad',
    friend_activity: 'Actividad de amigos',
    section_weekly: 'SEMANAL',
    weekly_recap: 'Resumen semanal',
    section_reengagement: 'REACTIVACI\u00D3N',
    welcome_back: 'Recordatorio de vuelta',
    daily_title: 'La palabra de hoy est\u00E1 lista',
